...
分层总依赖矩阵以 `oh-my-robot/document/architecture/分层与依赖规范.md` 为准，本文只定义 OSAL+SYNC 专项约束。
...
1. 原文件：历史混合文档
2. 拆分策略：保留原信息并以 OSAL 机制视角组织，SYNC 语义见 oh-my-robot/lib/sync/doc/SYNC顶层设计指南ForAGENTS.md。
